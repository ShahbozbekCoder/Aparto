...
class SellBottomSheetFragment : BottomSheetDialogFragment() {

    private var _binding: FragmentSellBottomSheetBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentSellBottomSheetBinding.inflate(inflater,container,false)
        return binding.root
    }
